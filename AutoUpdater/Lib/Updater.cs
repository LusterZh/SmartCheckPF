...
namespace Ezhu.AutoUpdater
{
    public class Updater
    {
        ...
        public static void CheckUpdateStatus()
        {
            ...
            {
                string url = Constants.RemoteUrl + "/update.xml";
                ...
                client.DownloadDataAsync(new Uri(url, UriKind.Absolute));
        ...
        public virtual Version CurrentVersion
        {
            ...
            get { return new Version(Application.ResourceAssembly.GetName().Version.ToString()); }
