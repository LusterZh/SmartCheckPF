...
class dataset_loader(data.Dataset):
    def __init__(self, input_folder, num_class, transform=None):
        self.imgs_path = []
        self.labels = []
        ...
        self.down_ratio = float(system_config.Detector["down_ratio"])
    ...
    def __getitem__(self, index):
        ...
        output_h, output_w = int(input_h//self.down_ratio), int(input_w//self.down_ratio)
        ...
        for k in range(num_objs):
            ...
            bbox = [i / self.down_ratio for i in bbox]
